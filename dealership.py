...
def addToFavorites():
    if 'username' in session:  
        ...
        cursor2.execute('INSERT INTO jackfavorites VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)', (dataDict['vin'], dataDict['make'], dataDict['model'], dataDict['year'], dataDict['color'], dataDict['mileage'], dataDict['price'], dataDict['our_price'], dataDict['transmission'], dataDict['body_style'], dataDict['car_photo'], UserID,))
        mysql.connection.commit()
